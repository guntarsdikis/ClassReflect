...
-- Drop and recreate with correct collation
...
CREATE PROCEDURE `create_prompt_version`(
  IN p_provider VARCHAR(20) COLLATE utf8mb4_unicode_ci,
  IN p_name VARCHAR(100) COLLATE utf8mb4_unicode_ci,
  IN p_prompt_template LONGTEXT COLLATE utf8mb4_unicode_ci,
  IN p_description TEXT COLLATE utf8mb4_unicode_ci,
  IN p_change_description TEXT COLLATE utf8mb4_unicode_ci,
  IN p_created_by VARCHAR(255) COLLATE utf8mb4_unicode_ci
)
BEGIN
  ...
  FROM prompts
  WHERE provider = p_provider COLLATE utf8mb4_unicode_ci AND name = p_name COLLATE utf8mb4_unicode_ci;
...
CREATE PROCEDURE `revert_to_prompt_version`(
  ...
  IN p_name VARCHAR(100) COLLATE utf8mb4_unicode_ci,
  IN p_version INT,
  IN p_reverted_by VARCHAR(255) COLLATE utf8mb4_unicode_ci
)
BEGIN
  ...
  FROM prompts
  WHERE provider = p_provider COLLATE utf8mb4_unicode_ci
    AND name = p_name COLLATE utf8mb4_unicode_ci
